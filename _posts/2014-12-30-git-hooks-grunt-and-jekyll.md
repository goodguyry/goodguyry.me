...
excerpt: Here are some notes about getting Node, Grunt and Jekyll running on a shared Dreamhost server.
...
{% figure "From the <a href='https://github.com/creationix/nvm#manual-install'>NVM Readme</a>" %}
...
{% figure 'Set <code>autolibs</code> in the <code>curl</code> command &ndash; not after, as the docs suggest.' %}
{% highlight shell-session %}
...
{% figure 'Be sure to substitute your OS and versions if they differ from mine' %}
{% highlight shell-session %}
...
{% figure 'Re-create the necessary parts of your login environment' %}
{% highlight bash %}
#!/bin/bash
